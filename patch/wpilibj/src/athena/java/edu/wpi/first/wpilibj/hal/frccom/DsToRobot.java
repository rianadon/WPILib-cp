...
public class DsToRobot {
    ...
    public static enum RequestType {
        ...
        UNCONNECTED, RESTART_CODE, REBOOT, NORMAL
    }
    ...
    public static DsToRobot fromByteArray(byte[] buffer) {
        ...
        switch(buffer[3] & 0x03) {
            ...
            case 1:
                ...
                break;
            case 2:
                controlMode = ControlMode.AUTON;
                break;
            default:
                throw new RuntimeException("Invalid control mode");
        }
        RequestType requestType = null;
        switch(buffer[4] & 0xFF) {
            case 0x00:
                requestType = RequestType.UNCONNECTED;
                break;
            case 0x04:
                requestType = RequestType.RESTART_CODE;
                break;
            case 0x08:
                requestType = RequestType.REBOOT;
                break;
            case 0x80:
